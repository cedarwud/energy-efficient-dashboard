...
const Dashboard: React.FC = () => {
  const [usrpCurrentPercent, setUsrpCurrentPercent] = useState(0);
  const [usrpPowerPercent, setUsrpPowerPercent] = useState(0);
  const [radarAccPowerPercent, setRadarAccPowerPercent] = useState(0);
  const [usrpAccPowerPercent, setUsrpAccPowerPercent] = useState(0);
  const [totalAccPowerPercent, setTotalAccPowerPercent] = useState(0);
  ...
  const handleNewData = debounce((data) => {
    ...
    const usrpCurrent = usrpData.current;
    const usrpPower = usrpData.power;
